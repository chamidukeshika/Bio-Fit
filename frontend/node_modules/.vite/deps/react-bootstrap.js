...
import {
  ...
  require_warning,
  useCol
} from "./chunk-NSCW4SXP.js";
import {
  Button_default,
  Button_default2,
  useButtonProps
} from "./chunk-TZECOOPJ.js";
import {
  DEFAULT_BREAKPOINTS,
...
function useTimeout() {
  ...
  const handleRef = (0, import_react28.useRef)();
...
var Carousel = React26.forwardRef(({
  ...
  const nextDirectionRef = (0, import_react29.useRef)(null);
  const [direction, setDirection] = (0, import_react29.useState)("next");
  const [paused, setPaused] = (0, import_react29.useState)(false);
  const [isSliding, setIsSliding] = (0, import_react29.useState)(false);
  const [renderedActiveIndex, setRenderedActiveIndex] = (0, import_react29.useState)(activeIndex || 0);
  ...
  const prev = (0, import_react29.useCallback)((event) => {
    if (isSliding) {
      return;
    }
  ...
  const elementRef = (0, import_react29.useRef)();
  ...
  const handleEnter = (0, import_react29.useCallback)((node) => {
    triggerBrowserReflow(node);
    onSlide == null ? void 0 : onSlide(renderedActiveIndex, slideDirection);
  }, [onSlide, renderedActiveIndex, slideDirection]);
  const handleEntered = (0, import_react29.useCallback)(() => {
    setIsSliding(false);
    onSlid == null ? void 0 : onSlid(renderedActiveIndex, slideDirection);
  ...
  const handleMouseOver = (0, import_react29.useCallback)((event) => {
    if (pause === "hover") {
      setPaused(true);
    }
    onMouseOver == null ? void 0 : onMouseOver(event);
  }, [pause, onMouseOver]);
  const handleMouseOut = (0, import_react29.useCallback)((event) => {
    setPaused(false);
    onMouseOut == null ? void 0 : onMouseOut(event);
  }, [onMouseOut]);
  const touchStartXRef = (0, import_react29.useRef)(0);
  const touchDeltaXRef = (0, import_react29.useRef)(0);
  const touchUnpauseTimeout = useTimeout();
  const handleTouchStart = (0, import_react29.useCallback)((event) => {
  ...
  const handleTouchMove = (0, import_react29.useCallback)((event) => {
  ...
  const handleTouchEnd = (0, import_react29.useCallback)((event) => {
    if (touch) {
  ...
  const intervalHandleRef = (0, import_react29.useRef)();
  (0, import_react29.useEffect)(() => {
  ...
  const indicatorOnClicks = (0, import_react29.useMemo)(() => indicators && Array.from({
    length: numChildren
  }, (_, index) => (event) => {
...
function useUncontrolledProp2(propValue, defaultValue, handler) {
  const wasPropRef = (0, import_react30.useRef)(propValue !== void 0);
  const [stateValue, setState] = (0, import_react30.useState)(defaultValue);
  ...
  return [isProp2 ? propValue : stateValue, (0, import_react30.useCallback)((...args) => {
...
function useForceUpdate() {
  const [, dispatch] = (0, import_react31.useReducer)((state) => !state, false);
  return dispatch;
}
...
function useSafeState(state) {
  const isMounted = useMounted();
  return [state[0], (0, import_react32.useCallback)((nextState) => {
    if (!isMounted())
      return;
...
function useDropdownMenu(options = {}) {
  const context5 = (0, import_react35.useContext)(DropdownContext_default);
...
var $b5e257d569688ac6$var$SSRContext = (0, import_react36.default).createContext($b5e257d569688ac6$var$defaultContext);
var $b5e257d569688ac6$var$IsSSRContext = (0, import_react36.default).createContext(false);
function $b5e257d569688ac6$var$LegacySSRProvider(props) {
  let cur = (0, import_react36.useContext)($b5e257d569688ac6$var$SSRContext);
  ...
  return (0, import_react36.default).createElement($b5e257d569688ac6$var$SSRContext.Provider, {
    value
  }, (0, import_react36.default).createElement($b5e257d569688ac6$var$IsSSRContext.Provider, {
    value: isSSR
  }, props.children));
}
var $b5e257d569688ac6$var$warnedAboutSSRProvider = false;
function $b5e257d569688ac6$export$9f8ac96af4b1b2ae(props) {
  if (typeof (0, import_react36.default)["useId"] === "function") {
  ...
  return (0, import_react36.default).createElement($b5e257d569688ac6$var$LegacySSRProvider, props);
}
...
function Dropdown({
  ...
  const context5 = (0, import_react40.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
...
var NavItem = React53.forwardRef((_ref, ref) => {
  ...
  return (0, import_jsx_runtime49.jsx)(Component2, Object.assign({}, options, props, {
    ref
  }));
});
...
var Nav = React54.forwardRef((_ref, ref) => {
  ...
  return (0, import_jsx_runtime50.jsx)(SelectableContext_default.Provider, {
    value: handleSelect,
    children: (0, import_jsx_runtime50.jsx)(NavContext_default.Provider, {
      value: {
        role,
      ...
      children: (0, import_jsx_runtime50.jsx)(Component2, Object.assign({}, props, {
        onKeyDown: handleKeyDown,
        ref: mergedRef,
        role
      }))
...
var RTGTransition = React57.forwardRef((_ref, ref) => {
  let {
    component: Component2
  } = _ref, props = _objectWithoutPropertiesLoose9(_ref, _excluded8);
  const transitionProps = useRTGTransitionProps(props);
  return (0, import_jsx_runtime53.jsx)(Component2, Object.assign({
    ref
  }, transitionProps));
});
...
function renderTransition(component, runTransition, props) {
  if (component) {
    return (0, import_jsx_runtime54.jsx)(RTGTransition_default, Object.assign({}, props, {
      component
    }));
  }
  if (runTransition) {
    return (0, import_jsx_runtime54.jsx)(ImperativeTransition, Object.assign({}, props, {
      transition: runTransition
    }));
  }
  return (0, import_jsx_runtime54.jsx)(NoopTransition_default, Object.assign({}, props));
}
...
var Modal = (0, import_react52.forwardRef)((_ref, ref) => {
  let {
    ...
    restoreFocusOptions,
    renderDialog,
    renderBackdrop = (props) => (0, import_jsx_runtime55.jsx)("div", Object.assign({}, props)),
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime55.jsx)("div", Object.assign({}, dialogProps, {
    children: React59.cloneElement(children, {
      role: "document"
    })
  }));
  ...
  return (0, import_jsx_runtime55.jsx)(import_jsx_runtime56.Fragment, {
    children: import_react_dom2.default.createPortal((0, import_jsx_runtime57.jsxs)(import_jsx_runtime56.Fragment, {
...
var ModalBody = React60.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ModalContext = React61.createContext({
...
var AbstractModalHeader = React64.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
  ...
  const context5 = (0, import_react53.useContext)(ModalContext_default);
...
var ModalHeader = React65.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var Modal2 = React67.forwardRef(({
  ...
  const renderBackdrop = (0, import_react54.useCallback)((backdropProps) => (0, import_jsx_runtime65.jsx)("div", {
    ...backdropProps,
...
var NavItem2 = React68.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var NavLink = React69.forwardRef(({
  bsPrefix,
  className,
  as: Component2 = Anchor_default,
  active,
...
var Nav2 = React70.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
    bsPrefix: initialBsPrefix,
    variant,
...
var NavbarBrand = React71.forwardRef(({
  bsPrefix,
  className,
  as,
  ...props
...
var NavbarCollapse = React72.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
...
var NavbarToggle = React73.forwardRef(({
  bsPrefix,
  className,
  children,
...
var OffcanvasBody = React74.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var OffcanvasToggling = React75.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
  ...
  return (0, import_jsx_runtime73.jsx)(TransitionWrapper_default, {
    ...
    ...props,
    childRef: children.ref,
    children: (status, innerProps) => React75.cloneElement(children, {
      ...innerProps,
...
var OffcanvasHeader = React76.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var OffcanvasTitle = React77.forwardRef(({
  className,
  bsPrefix,
...
var Offcanvas = React78.forwardRef(({
  ...
  const renderBackdrop = (0, import_react60.useCallback)((backdropProps) => (0, import_jsx_runtime76.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React79.forwardRef((props, ref) => {
  const context5 = (0, import_react61.useContext)(NavbarContext_default);
...
var NavbarText = React80.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var PopoverHeader = React84.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var PopoverBody = React85.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Overlay2 = React89.forwardRef(({
  children: overlay,
  transition = Fade_default,
  popperConfig = {},
  rootClose = false,
  ...
  return (0, import_jsx_runtime90.jsx)(Overlay_default, {
    ...
    children: (overlayProps, {
      ...
      return React89.cloneElement(overlay, {
        ...overlayProps,
        placement: updatedPlacement,
        arrowProps,
        popper,
...
var OverlayTrigger = ({
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React90.Children.only(children).props : {};
  const attachRef = (r) => {
    mergedRef(safeFindDOMNode(r));
  };
  ...
  return (0, import_jsx_runtime93.jsxs)(import_jsx_runtime92.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react67.cloneElement)(children, triggerProps), (0, import_jsx_runtime91.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var PageItem = React91.forwardRef(({
  active = false,
  disabled = false,
  className,
  style: style2,
...
function createButton(name, defaultValue, label = name) {
  const Button = React91.forwardRef(({
    children,
    ...props
...
var Pagination = React92.forwardRef(({
  bsPrefix,
  className,
  size: size2,
  ...props
...
function useTabPanel(_ref) {
  ...
  const context5 = (0, import_react69.useContext)(TabContext_default);
  if (!context5)
    return [Object.assign({}, props, {
      role
    }), {
...
var TabContent = React104.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ToastFade = React108.forwardRef((props, ref) => (0, import_jsx_runtime114.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React110.forwardRef(({
  ...
  const context5 = (0, import_react71.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
...
var ToastBody = React111.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props

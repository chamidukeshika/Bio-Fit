...
import {
  ...
  useVariantColor
} from "./chunk-NRV2SQKA.js";
import {
  ListItemButtonOrientationContext_default
} from "./chunk-5ZYY3CYI.js";
import {
  useButton,
  useMenuItem,
...
var _excluded2 = ["children", "disabled", "component", "selected", "color", "orientation", "variant", "slots", "slotProps", "id"];
...
var MenuItem = React2.memo(React2.forwardRef(function MenuItem2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyMenuItem"
  });
  ...
  return (0, import_jsx_runtime2.jsx)(ListItemButtonOrientationContext_default.Provider, {
    value: orientation,
...
var StableMenuItem = React2.forwardRef(function StableMenuItem2(props, ref) {
  const {
    contextValue,
    id
  ...
  return (0, import_jsx_runtime2.jsx)(ListContext.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime2.jsx)(MenuItem, _extends({}, props, {
      id,
      ref
    }))
  });
...
//# sourceMappingURL=@mui_joy_MenuItem.js.map

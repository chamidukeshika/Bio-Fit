import "./chunk-MEOAX5PF.js";
import {
  useThemeProps
} from "./chunk-5OXOUMFZ.js";
import "./chunk-FMFFUJ5P.js";
import "./chunk-PNFMNAIN.js";
import "./chunk-J3Y545FX.js";
import "./chunk-V3EMTNWQ.js";
import {
  getPanelId,
  getTabId,
  useTabContext
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime20.jsx)(React40.Fragment, {
...
function useNumberInput(parameters) {
  ...
  const handleStateChange = React41.useCallback((event, field, fieldValue, reason) => {
  ...
  const numberInputActionContext = React41.useMemo(() => {
    return {
      min,
      max,
      step,
  ...
  const [state, dispatch] = useControllableReducer({
    ...
    initialState,
    onStateChange: handleStateChange,
    actionContext: React41.useMemo(() => numberInputActionContext, [numberInputActionContext]),
    componentName
  });
  const {
    value,
...
function useTabs(parameters) {
  ...
  const getTabId2 = React59.useCallback((tabPanelId) => {
...
var TextareaAutosize = React70.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  const calculateTextareaStyles = React70.useCallback(() => {
...
var TabPanel3 = React74.forwardRef(function TabPanel4(inProps, ref) {
